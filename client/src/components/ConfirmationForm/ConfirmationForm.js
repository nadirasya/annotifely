...
// use props event handler for handling event on 'Confirm' Button
// use props cancel event handler for handling cancel event on 'Cancel' Button
// use props 'confirmationForm' (true or false value to show/hide popup)' for activating transition

const ConfirmationForm = ({message, handleClickCancel, handleClickConfirm, confirmationForm}) => {
