...
const TaskForm= () => {
    ...
    <div>
        ...
        <div className={classes.popupContainer}>
            <OutsideAlerter>
                <ConfirmationForm message="Are you sure you want to delete this image?" handleClickCancel={handleCancelRemoveImage} handleClickConfirm={handleRemoveImage} confirmationForm={confirmation}/>
            </OutsideAlerter>
        </div>
        : null }
    </div>
